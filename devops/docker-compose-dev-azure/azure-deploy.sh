...
resourcename="walkiesr-us"  # lower case, only
resourcegroup="walkiesr-us_rg"
...
# git clone https://github.com/apilogicserver/walkiesr-us.git
# cd walkiesr-us
...
az group create --name walkiesr-us_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group walkiesr-us_rg --sku S1 --is-linux
az container create --resource-group walkiesr-us_rg --name walkiesr-us --image apilogicserver/walkiesr-us:latest --dns-name-label walkiesr-us --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//walkiesr-us.westus.azurecontainer.io:5656'
